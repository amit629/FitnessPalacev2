    ...
    <>
        <div className="container-fluid">
            ...
            <div className="AboutText mt-2 ms-2">
                <h2>{data.name}</h2>
                <p>{data.current_opening_hours==undefined?'':data.current_opening_hours.open_now?<span className='text-success'>open now</span>:<span className='text-danger'>Closed</span>}</p>
